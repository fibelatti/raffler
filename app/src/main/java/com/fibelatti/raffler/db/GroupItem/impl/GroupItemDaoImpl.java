package com.fibelatti.raffler.db.GroupItem.impl;
...
public class GroupItemDaoImpl
        ...
        implements GroupItemSchema, GroupItemDao {

    private Cursor cursor;
    private ContentValues initialValues;

    public GroupItemDaoImpl(SQLiteDatabase db) {
        super(db);
    }
    ...
    private boolean addGroupItem(GroupItem groupItem) {
        ...
        try {
            AnalyticsHelperImpl.getInstance().fireCreateGroupEvent();
