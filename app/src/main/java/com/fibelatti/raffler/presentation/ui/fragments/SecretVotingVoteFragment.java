...
import com.fibelatti.raffler.presentation.ui.adapters.VoteAdapter;
...
public class SecretVotingVoteFragment
    ...
    private SecretVotingVoteListener listener;
    ...
    public void onAttach(Context context) {
        ...
        try {
            listener = (SecretVotingVoteListener) context;
    ...
    private void showConfirmVoteDialog() {
        dialogHelper.createYesNoDialog(
                ...
                (dialog, id) -> listener.addVote(group.getItem(voteIndex)),
                (dialog, id) -> {
